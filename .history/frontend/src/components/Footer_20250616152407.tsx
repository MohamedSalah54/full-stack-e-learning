  ...
  return (
    <footer className="bg-gray-800 text-white">
      ...
      <div className="bg-gray-800 text-white py-4 px-6 md:px-16 lg:px-24 flex flex-col md:flex-row justify-between items-center text-sm">
        {/* Left side */}
        <div className="flex items-center gap-2 mb-4 md:mb-0 cursor-pointer" onClick={() => router.push('/home')}>
          <img src="/logo.png" alt="Logo" className="w-8 h-8 invert" /> {/* invert عشان تبقى بيضاء */}
          <span>cademyX</span>
