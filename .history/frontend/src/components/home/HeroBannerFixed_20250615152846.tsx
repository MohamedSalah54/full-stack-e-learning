...
const HeroBannerFixed = () => {
  return (
    <section className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
      {/* Background Image */}
      <img
        src="/hero-fixed.jpg" // غيّر المسار حسب صورتك
        alt="Hero"
      ...
      <div className="absolute inset-0 flex items-center justify-start px-6 md:px-20">
        <div className="text-white max-w-md">
          <h1 className="text-3xl md:text-5xl font-bold mb-3">Achieve More with cademyX</h1>
          <span className="block text-lg md:text-xl mb-6">Empower your future with quality learning</span>
