...
<div
  key={index}
  className="w-full max-w-[360px] mx-auto rounded-2xl shadow-md border border-gray-200 overflow-hidden hover:shadow-xl transition duration-300 flex flex-col min-h-[550px]"
>
                            >
                                {/* Top Border */}
