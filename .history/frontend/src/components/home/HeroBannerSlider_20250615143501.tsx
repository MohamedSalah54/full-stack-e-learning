...
const HeroBannerSlider = () => {
  ...
  return (
    <>
      <section className="w-full h-[400px] responsive-height relative overflow-hidden bg-white">
        ...
        <div className="absolute top-1/2 left-[170px] responsive-left transform -translate-y-1/2 z-30">
      ...
      <div className="w-full text-left py-10 bg-white pl-32 responsive-padding">
        <h1 className="text-3xl font-bold text-gray-900 mb-4 responsive-title">Ready to reimagine your career?</h1>
        <p className="text-lg text-gray-700 max-w-xl responsive-text">
