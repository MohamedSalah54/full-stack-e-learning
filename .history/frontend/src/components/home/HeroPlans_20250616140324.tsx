...
export default function HeroPlans() {
  return (
    <section className="w-full bg-white py-16 px-4">
      <div className="max-w-6xl mx-auto ml-6"> {/* تحريك الكروت لليمين */}
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="mb-6 text-left">
                    ...
                    <p className="text-sm text-gray-500 mb-2">for {plan.type}</p>
                  ...
                  {/* Price */}
                  <p className="text-2xl font-bold text-gray-900 text-left mb-6">
                    {plan.price}
                  </p>
