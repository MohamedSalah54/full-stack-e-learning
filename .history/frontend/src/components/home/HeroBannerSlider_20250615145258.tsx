  ...
  return (
    <>
      ...
      <section className="w-full relative bg-white overflow-hidden">
        ...
        <div className="w-full h-[300px] sm:h-[400px] md:h-[500px] relative">
          {slides.map((slide, index) => (
            <img
              ...
              src={slide.image}
              alt="Hero"
              className={`absolute top-0 left-0 w-full h-full object-cover object-right transition-opacity duration-700 ${
        ...
        {/* Text Box - inside image on desktop, outside image on mobile */}
        <div className="absolute hidden md:block top-1/2 left-[170px] transform -translate-y-1/2 z-30">
