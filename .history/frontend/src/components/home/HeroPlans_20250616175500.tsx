                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {heroPlans.map((plan, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="w-full rounded-2xl shadow-md border border-gray-200 overflow-hidden hover:shadow-xl transition duration-300 flex flex-col min-h-[550px]"
                            >
                                {/* Top Border */}
                                ...
                                <div className="p-6 flex flex-col flex-grow">
                                    ...
                                    <div className="flex justify-center mb-6">
                                        <button className="flex items-center gap-2 bg-gray-800 text-white px-6 py-3 rounded-full hover:bg-gray-700 transition cursor-pointer">
                                            Try it free
