    ...
    <nav className="bg-white shadow-sm border-b border-gray-200 py-3 px-6">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <button className="px-4 py-1 border border-gray-800 text-gray-800 rounded-md hover:bg-gray-100 transition cursor-pointer" onClick={()=>router.push('/auth/login')}>
            Login
          </button>
          <button className="px-4 py-1 bg-gray-800 text-white rounded-md hover:bg-gray-700 transition cursor-pointer" onClick={()=>router.push('/auth/register')} >
            Sign Up
          </button>
